...
- **Animation and skinning** – Future implementation plan for glTF clips and skeletal deformation. See [animation-skinning-roadmap.md](animation-skinning-roadmap.md).
